...
<div style="display:none;"><script type="text/javascript">ok3w_ads("s014");</script></div>
<!-- 中间广告位2 -->
        ...
        <DIV class=mm id=bodyTd>
     	 <DIV id=printBody style="WORD-BREAK: break-all"> <!--开始-->
     		 <DIV style="TEXT-ALIGN: center">
     			 <H1 class=aTitle>${news.title }</H1>
     		 </DIV>
		   <div class="luru_c"><span style="float:left;">作者：${news.author.name } 发表时间：${news.date} 点击量：${news.click} <a href="news_like?id=${news.id}" target="_self">热度:${news.like}</a></span><span style="float:right; color:#194d7d;"><!--[字体：<A  href="javascript:ContentSize(16)">大</A> <A 
